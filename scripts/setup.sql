...
CREATE OR REPLACE STAGE RAW_DATA; --to store data assets
CREATE OR REPLACE STAGE NOTEBOOK; --to store notebook assets
CREATE OR REPLACE STAGE CHATBOT_APP; --to store streamlit assets
...
-- create csv format
CREATE FILE FORMAT IF NOT EXISTS SALES_CALLS_DB.SALES_CALLS_SCHEMA.CSVFORMAT 
    SKIP_HEADER = 1 
    TYPE = 'CSV';
